# ============================================================================
# CPB v2: Improved Version - Binary Classification + Better Features
# 
# Key Improvements:
# 1. Binary classification (Up vs Down) - simplify problem
# 2. New features: momentum, acceleration, volatility ratio, price position
# 3. Stronger Focal Loss (alpha=0.5, gamma=3.0)
# 4. Shorter Lookback (36 -> 12 hours)
