# ============================================================================
# CPB v2: 完整单 Cell 训练脚本 (一次执行全部流程)
# 直接复制粘贴到 Colab 执行！
# ============================================================================

print('='*70)
print('CPB v2: 完整训练流程 (单 Cell 版本)')
print('='*70)
...
CONFIG = {
    ...
    'lookback': 60,
    'n_features': 30,
    'use_dummy_data': False  # True=使用测试数据, False=从Binance下载
}
...
class BinanceDataCollector:
    ...
    BASE_URL = "https://api.binance.us/api/v3"  # US端点
    MAX_CANDLES = 1000
    ...
    def get_klines(self, symbol, interval="15m", limit=3000):
        ...
        start_time = int((datetime.now(datetime.timezone.utc) - timedelta(days=90)).timestamp() * 1000)
