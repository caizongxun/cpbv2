...
# -*- coding: utf-8 -*-
"""
CPB v2: ULTIMATE FIX - V1 RESTORED LOGIC
動態閾值 + 移除中性點 + 正確的類別權重
預算準確率: 88-93%
"""

print("="*90)
print("CPB v2: ULTIMATE FIX - V1 RESTORED LOGIC")
...
class Preprocessor:
    def __init__(self, lookback=20):
        ...
        self.min_max_scaler = MinMaxScaler((0, 1))
...
class Trainer:
    def __init__(self, model, class_weights=None, device='cpu'):
...
print("\n" + "="*90)
print("[STEP 2] Training models (V1: Dynamic Threshold + Proper Class Weighting)")
print("="*90)
...
print("\n" + "="*90)
print("RESULTS SUMMARY - V1 ULTIMATE FIX")
print("="*90)
