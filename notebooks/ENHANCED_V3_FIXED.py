# ============================================================================
# CPB v2: Enhanced Version 3 - FIXED
# Fixes:
# - Removed BatchNorm (causing issues in small batches)
# - Better error handling
# - Fix variable naming bugs
# ============================================================================

print('='*90)
print('CPB v2: ENHANCED VERSION 3 - STABLE & RELIABLE')
...
class EnhancedFeatureEngineer:
    ...
    def calculate_all(self):
        df = self.df
        print('    [FEATURES] Building 28-feature set...')
        ...
        print(f'    [FEATURES] Total: {len(self.get_features())} features')
        return self.df
        ...
        for epoch in range(config['epochs']):
            ...
            if val_acc > best_val_acc:
                ...
                if patience_counter >= config['early_stop_patience']:
                    print(f'    Early Stop at epoch {epoch+1} (Best: {best_val_acc:.4f})')
                    if best_weights:
...
for coin in all_data:
    ...
    try:
        ...
        if len(X) < 50:
            print(f'    X Insufficient data (only {len(X)} sequences)')
            continue
...
if results:
    ...
    if avg_acc > 0.80:
        print(f'\nStatus: EXCELLENT! Significant improvement from baseline (50%)')
    elif avg_acc > 0.70:
        print(f'\nStatus: GOOD! Solid improvement')
    elif avg_acc > 0.60:
        print(f'\nStatus: OK - Room for improvement')
    else:
        print(f'\nStatus: Keep working on features and architecture')
else:
