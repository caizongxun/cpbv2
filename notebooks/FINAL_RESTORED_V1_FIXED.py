...
# -*- coding: utf-8 -*-
"""
CPB v2: RESTORED V1 LOGIC - FIXED
動態閾值 + 移除中性點
預算準確率: 88-93%
"""

print("="*90)
print("CPB v2: RESTORED V1 LOGIC - FIXED")
...
print("\n" + "="*90)
print("[STEP 2] Training models (V1: Dynamic Threshold + Neutral Points Removal)")
print("="*90)
...
if results:
    ...
    if avg_acc > 0.85:
        ...
        print(f"\nStatus: Results show data quality needs investigation")
