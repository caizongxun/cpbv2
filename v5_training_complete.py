#!/usr/bin/env python3
"""
CPB v5: Complete Training Pipeline (All-in-One)

Designed to be executed in Google Colab with:
  import requests
...
Or in a Colab cell:
  !python v5_training_complete.py
...
class TechnicalIndicators:
    ...
    def calculate_all_features(df: pd.DataFrame) -> pd.DataFrame:
        ...
        df['rsi_14'] = _rsi(df['close'].values, 14)
        df['rsi_21'] = _rsi(df['close'].values, 21)
...
def main():
    print("="*60)
    print("CPB v5: Complete Training Pipeline")
    print("="*60)
